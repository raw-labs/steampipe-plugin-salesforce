...
func SalesforceAsset(ctx context.Context, dm dynamicMap, config salesforceConfig) *plugin.Table {
	...
	return &plugin.Table{
		...
		Columns: mergeTableColumns(ctx, config, dm.cols, []*plugin.Column{
			...
			{Name: "created_date", Type: proto.ColumnType_TIMESTAMP, Description: "Date and time of the creation of the price book record.", Sort: plugin.SortAll},
			{Name: "description", Type: proto.ColumnType_STRING, Description: "Description of the asset."},
			{Name: "install_date", Type: proto.ColumnType_TIMESTAMP, Description: "Date when the asset was installed.", Sort: plugin.SortAll},
			...
			{Name: "last_referenced_date", Type: proto.ColumnType_TIMESTAMP, Description: "The date and time that the asset was last modified.", Sort: plugin.SortAll},
			{Name: "last_viewed_date", Type: proto.ColumnType_TIMESTAMP, Description: "The date and time that the asset was last viewed.", Sort: plugin.SortAll},
			...
			{Name: "purchase_date", Type: proto.ColumnType_TIMESTAMP, Description: "Date on which this asset was purchased.", Sort: plugin.SortAll},
			...
			{Name: "usage_end_date", Type: proto.ColumnType_TIMESTAMP, Description: "Date when usage for this asset ends or expires.", Sort: plugin.SortAll},
		}),
	}
}
